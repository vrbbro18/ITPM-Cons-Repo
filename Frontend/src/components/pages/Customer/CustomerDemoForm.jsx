...
import Footer from "../../Footer"; // Adjust path based on your structure
...
const CustomerDemoForm = () => {
  ...
  const [pageName, setPageName] = useState("CustomerForm");
...
export default CustomerDemoForm;