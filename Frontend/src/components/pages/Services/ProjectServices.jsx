      ...
      {showSuccessMessage && (
        <div className="success-message">
          <div className="success-message-content">
            ...
            <span className="text-gray-800 font-medium">Project Successfully Added</span>
          </div>
        </div>
      )}
      ...
      {showUpdateSuccessMessage && (
        <div className="success-message">
          <div className="success-message-content">
            ...
            <span className="text-gray-800 font-medium">Project Successfully Updated</span>
          </div>
        </div>
      )}
            ...
            <div className="modal-grid">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border ${editFormErrors.projectName ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
                {editFormErrors.projectName && (
                  <p className="mt-1 text-sm text-red-600">{editFormErrors.projectName}</p>
                )}
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.customerName ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.startDate ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.endDate ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.contactNo ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.serviceType ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
                {editFormErrors.serviceType && (
                  <p className="mt-1 text-sm text-red-600">{editFormErrors.serviceType}</p>
                )}
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.message ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
                {editFormErrors.message && (
                  <p className="mt-1 text-sm text-red-600">{editFormErrors.message}</p>
                )}
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.adminNote ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
                {editFormErrors.adminNote && (
                  <p className="mt-1 text-sm text-red-600">{editFormErrors.adminNote}</p>
                )}
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <input
                  ...
                  onChange={handleEditFormChange}
                  className={`w-full px-3 py-2 border ${editFormErrors.budget ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
                {editFormErrors.budget && (
                  <p className="mt-1 text-sm text-red-600">{editFormErrors.budget}</p>
                )}
              </div>
            </div>
          ...
          <div className="form-grid">
            <div>
              ...
              <select
                ...
                className={`w-full px-3 py-2 border ${errors.projectName ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:ring-primary focus:border-primary`}
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-2 border ${errors.customerName ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:ring-primary focus:border-primary`}
